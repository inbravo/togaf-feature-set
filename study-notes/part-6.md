...
- ***Compliant***- Some specs features are not implemented, but ***All implemented features AS PER Specs***
- ***Conformant***- All specification features are implemented, but ***Some other implemented features NOT PART-OF Specs***
